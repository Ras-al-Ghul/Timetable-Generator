...
int fillinlabs(vector<int> &LabDS,vector<elementOfChromosome*>* chromosome,vector <Lab*>* listoflabs,vector <Batch*>* listofbatches\
    ...
    tr(templabs,it){
        ...
        while((*it)->get_allocated()==0&&(*it)->get_numperweek()==2&&((*it)->get_sem()==3||(*it)->get_sem()==5)){
            int counts=0;
            int olddayofweek=-1;
            while(counts<2){
    ...
    tr(templabs,it){
        ...
        while((*it)->get_allocated()==0&&(*it)->get_numperweek()==1&&((*it)->get_sem()==5)){
            string prof1,prof2;
            prof1=(*it)->get_prof_name1();prof2=(*it)->get_prof_name2();
    ...
    olddayofweek=-1;
    tr(templabs,it){
        while((*it)->get_allocated()==0&&(*it)->get_numperweek()==2&&((*it)->get_sem()==7)){
            int counts=0;
        while(counts<2){
            string prof1,prof2;
            prof1=(*it)->get_prof_name1();prof2=(*it)->get_prof_name2();
            ...
            labelss:
                ...
                if(LabDS[(((dayofweek-1)*3)+((hourofday/2)-1))]+2<7&&tempchromosome[tempnum1]->labornot!=0&&tempchromosome[tempnum2]->labornot!=0&&\
                   tempchromosome[tempnum1]->labornot!=1&&tempchromosome[tempnum2]->labornot!=1){
